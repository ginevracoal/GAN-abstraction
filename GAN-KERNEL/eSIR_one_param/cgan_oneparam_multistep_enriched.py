	...
	def plot_test_hist(self, gen_trajs, scaled_flag):
		...
		for i, init_state in enumerate(self.x0_val):
			for t in range(self.T):
				...
				fig.savefig(figname)
				pyplot.close()
		fname = 'Results/Enriched_Scaled={}_wass_dist_{}steps.npy'.format(scaled_flag, Nsteps)
		...
		figname = "Results/Enriched_Scaled={}_avg_wass_distance_{}steps.png".format(scaled_flag, Nsteps)
		fig.savefig(figname)
...
cgan.set_T(Nsteps)
cgan.load_real_samples('Datasets/eSIR_enriched_training_set_one_param.pickle')
