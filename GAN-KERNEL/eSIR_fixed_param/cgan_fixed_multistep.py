...
class CGAN_KERN(object):
	...
	def train(self, n_epochs=10, n_batch=64, n_gen=5):
		...
		filename2 = 'Models/trained_gen_model.h5'
...
cgan.define_gan()
# load image data
cgan.load_real_samples('Datasets/eSIR_training_set_fixed_param_32steps.pickle')

if DO_TRAIN:
	# train model
	cgan.train(n_epochs = N_EPOCHS, n_batch = 256, n_gen=Ngen)
else:
	cgan.generator = load_model('val_dcgan_model_final.h5')
