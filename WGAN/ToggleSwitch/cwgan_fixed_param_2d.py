...
PLOTS_PATH = "Plots/2d_Emb_"+embedding+"_Plots_EP={}_BAT={}_LRs={}_{}_N_CR={}_N_CH={}_Q={}_CC={}".format(N_EPOCHS,BATCH_SIZE,C_LR,G_LR, N_CRITIC, N_CH, Q, CLIP_CONST)
try:
    os.mkdir(PLOTS_PATH)
except OSError:
...
MODELS_PATH = "Models/2d_SavedModels_EP={}_BAT={}_LRs={}_{}_N_CR={}_N_CH={}_Q={}_CC={}".format(N_EPOCHS,BATCH_SIZE,C_LR,G_LR, N_CRITIC, N_CH, Q, CLIP_CONST)
try:
...
def compute_distances(valid_data, gen_trajectories):#valid_dict,initial_states
	...
	figname = "Results/Traj_avg_wass_distance_newer_setting_400ep.png"
	fig.savefig(figname)
	...
	distances_dict = {"ssa_count":ssa_histograms_count, "ssa_edg":ssa_histograms_edg,
	              ...
	              "wass_dist":dist}
	file = open('FixedParam_wgan_conv1d_distances.pickle', 'wb')
	# dump information to that file
...
trainset_file = 'Datasets/ToggleSwitch_training_set_fixed_param_red.pickle'
valset_file = 'Datasets/ToggleSwitch_validation_set_fixed_param_red.pickle'
...
# train model
DO_TRAIN = True
filename_gen = 'cwgan_fixed_param_generator_model_final.h5'
...
if DO_TRAIN:
	...
	trained_generator = load_model(filename_gen)

valid_data = load_test_data(HMAX, valset_file)
